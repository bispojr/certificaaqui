...
const { Certificado, Participante, Evento, TiposCertificados, Usuario, sequelize } = require('../../src/models');
...
beforeAll(async () => {
  ...
  const admin = await Usuario.create({ nome: 'Admin', email: 'admin_cert@test.com', senha: 'senha123', perfil: 'admin' });
