...
**Evidência concreta:**
```hbs
<a href="/public/certificados/{{certificado.id}}/pdf" class="btn btn-outline-primary" target="_blank">Baixar PDF</a>
```
...
*Auditoria realizada com base em análise estática do código-fonte. Não foram executados testes de penetração, análise dinâmica ou avaliação de infraestrutura de runtime.*
