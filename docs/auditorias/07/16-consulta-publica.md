...
*Auditoria realizada com base exclusivamente em evidências de código-fonte e documentação. Nenhuma suposição foi elevada a achado sem evidência concreta. Itens com dúvida foram classificados como Validação Humana (VH).*
