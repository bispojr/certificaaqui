...
| Delete/restore participante | `monitor` | *(nenhum)* | `gestor` ou `admin` |
...
| Delete participante | `monitor` | *(nenhum rbac)* | indefinido |
| Restore participante | `monitor` | *(nenhum rbac)* | indefinido |
