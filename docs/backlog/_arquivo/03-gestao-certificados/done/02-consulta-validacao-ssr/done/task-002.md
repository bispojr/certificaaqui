  ...
  <div class='col-md-7'>
    ...
    {{else}}
      <div class='card border-danger'>
        ...
        <div class='card-body'>
          <p class='text-danger'>Nenhum certificado foi encontrado com este
            código.</p>
        </div>
      </div>
    {{/if}}

    <a href='/public/pagina/validar' class='btn btn-link mt-3'>← Validar outro
      código</a>
  </div>
</div>
```
...
- Completado em: 2026-03-26 20:33 (BRT) ✅
